 ...
 * Featuring asymmetrical cloud lobes (larger left harvest-flame puff, smaller right marigold capsule)
 * and a center volumetric frosted glass teardrop pin. Single-accent orange system per DESIGN.md.
 */
export function LogoIcon({
  ...
  return (
    ...
    >
      <defs>
        {/* Left Lobe (Larger & Taller Harvest Flame Cloud Puff) */}
        <linearGradient id="silo-icon-leftGrad" x1="15%" y1="10%" x2="85%" y2="90%">
          <stop offset="0%" stopColor="#c2410c" />
          <stop offset="30%" stopColor="#ea580c" />
          <stop offset="60%" stopColor="#fa5d00" />
          <stop offset="85%" stopColor="#ff7a1f" />
          <stop offset="100%" stopColor="#ffab5c" />
        </linearGradient>

        <radialGradient id="silo-icon-leftGlow" cx="35%" cy="52%" r="55%">
          <stop offset="0%" stopColor="#ffd8a8" stopOpacity="0.95" />
          <stop offset="45%" stopColor="#ffb347" stopOpacity="0.8" />
          <stop offset="75%" stopColor="#fa5d00" stopOpacity="0.2" />
          <stop offset="100%" stopColor="#c2410c" stopOpacity="0" />
        </radialGradient>

        <linearGradient id="silo-icon-leftRim" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#ffd8a8" stopOpacity="0.95" />
          <stop offset="40%" stopColor="#fa5d00" stopOpacity="0.7" />
          <stop offset="100%" stopColor="#fee3b5" stopOpacity="0.95" />
        </linearGradient>
        ...
        <linearGradient id="silo-icon-rightGrad" x1="15%" y1="15%" x2="90%" y2="90%">
          ...
          <stop offset="85%" stopColor="#fee3b5" />
        ...
        <radialGradient id="silo-icon-rightGlow" cx="72%" cy="60%" r="50%">
          ...
          <stop offset="45%" stopColor="#fee3b5" stopOpacity="0.8" />
        ...
        <linearGradient id="silo-icon-rightRim" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" stopColor="#ffedc2" stopOpacity="0.95" />
        </linearGradient>

        {/* Frosted Glass Pin */}
        <linearGradient id="silo-icon-pinBody" x1="50%" y1="0%" x2="50%" y2="100%">
          <stop offset="0%" stopColor="#ffffff" stopOpacity="0.99" />
          <stop offset="22%" stopColor="#f1f0ec" stopOpacity="0.96" />
          <stop offset="50%" stopColor="#e3d6c5" stopOpacity="0.88" />
          <stop offset="72%" stopColor="#c0bbb6" stopOpacity="0.65" />
          <stop offset="90%" stopColor="#e3d6c5" stopOpacity="0.78" />
