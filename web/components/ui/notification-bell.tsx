...
// Doppler theme (web/DESIGN.md) — matches the bordered icon-buttons in dashboard-topbar.
const SURFACE = "bg-card border border-border";
const GLYPH = "text-foreground";
  ...
  function NotificationBell(
    ...
    return (
      <button
        ...
        data-slot="notification-bell"
        className={cn(
          "relative grid place-items-center rounded-lg outline-none transition-transform active:scale-90 focus-visible:ring-2 focus-visible:ring-ring motion-reduce:active:scale-100",
          SURFACE,
          GLYPH,
          className,
        )}
