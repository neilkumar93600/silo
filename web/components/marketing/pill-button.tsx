    ...
    <Link
      ...
      className={cn(
        ...
        variant === "filled"
          ...
          : "border border-lavender-mist bg-transparent text-ink-black hover:border-laser-violet hover:text-laser-violet hover:bg-laser-violet/10 active:scale-[0.98]",
        className,
      )}
    >
      {children}
